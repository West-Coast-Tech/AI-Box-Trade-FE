        ...
        <div>
            <div className="relative rounded-t-md bg-primary-light bg-[url('/assets/images/knowledge/pattern.png')] bg-contain bg-left-top bg-no-repeat px-5 py-10 dark:bg-black md:px-10">
                ...
                <div className="relative">
                    ...
                    <p className="mb-9 text-center text-base font-semibold pr-16 pl-10 sm:pl-0">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quaerere responsa instantanea et quaestiones a popularibus usoribus positas
                    </p>
            ...
            <div className="mb-10 mt-20 grid grid-cols-1 gap-10 md:grid-cols-2">
                <div className="rounded-md bg-white dark:bg-black">
                    <div className="border-b border-white-light p-6 text-[22px] font-bold dark:border-dark text-center dark:text-white">General topics?</div>
                ...
                <div className="rounded-md bg-white dark:bg-black">
                    <div className="border-b border-white-light p-6 text-[22px] font-bold dark:border-dark text-center dark:text-white">Quick support & Free update</div>
                    <div className="divide-y divide-white-light px-6 py-4.5 dark:divide-dark">
                        <div>
                            <div
                                className={`flex cursor-pointer items-center justify-between gap-10 px-2.5 py-2 text-base font-semibold hover:bg-primary-light hover:text-primary dark:text-white dark:hover:bg-[#1B2E4B] dark:hover:text-primary
            ...
            <div className="panel mt-10 text-center md:mt-20">
                <h3 className="mb-2 text-xl mt-16 font-bold dark:text-white md:text-2xl">Still need help?</h3>
                <div className="text-lg font-medium text-white-dark">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Contact us durante horas standard vel email nobis 24/7, et respondebimus tibi.
                </div>
                <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-6 mb-16">
